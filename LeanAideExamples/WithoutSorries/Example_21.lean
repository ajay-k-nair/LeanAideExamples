...
theorem finite_dimensional.eq_ker_sup_range_of_is_idempotent :
      ∀ {K : Type u} {V : Type v} [inst : DivisionRing K] [inst_1 : AddCommGroup V]
        [inst_2 : Module K V] [FiniteDimensional K V] (T : V →ₗ[K] V),
        T ^ (2 : ℕ) = T → IsCompl T.ker T.range :=
    by
    intro K V inst inst_1 inst_2 inst_7439058897038094550 T a_16360571734713782635
    exact IsCompl.symm (LinearMap.IsIdempotentElem.isCompl a_16360571734713782635)
